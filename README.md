...
├── SCHEMA.md                    # Phần mở rộng schema project-specific
├── schema-signals.md            # Phiếu promote/strain (tín hiệu tiến hóa schema)
...
│   └── registry.md              # Bảng registry skills
├── workflows/                   # Chuỗi nhiều skill
│   └── registry.md              # Bảng registry workflows
...
| **pk-capture** | Support | Ghi nhanh vào inbox thống nhất, tự phân loại, batch ingest nguồn lớn |
| **pk-distill** | Support | Đúc kết inbox tri thức thành wiki/skills/workflows |
| **pk-consult** | Support | Tra cứu kho tri thức, chạy skills/workflows, soạn lộ trình học |
...
| "soạn onboarding" / "dạy lại X" | `pk-consult` teach |
...
│   ├── pk-capture/          # Ghi nhanh + batch ingest
