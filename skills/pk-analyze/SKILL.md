...
Snapshot Contract (`../pk-shared/references/snapshot-contract.md`) đã preload: `tools.md`, `plan.md` frontmatter, `actions/*.md` frontmatter, `inbox/*.md` frontmatter + `captured_at`, `schema-signals.md`, `SCHEMA.md`, `knowledge/index.md`, `skills/registry.md`, `workflows/registry.md`, pinned pages. Không đọc lại những nguồn này.
