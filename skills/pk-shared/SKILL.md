...
| `quality-gate.md` | 3 câu hỏi nội bộ khi nhận input từ user | pk-init, pk-plan, pk-track |
...
Bảng "Skill tiêu thụ" trên là **bản phái sinh** (suy ra từ việc skill nào tham chiếu reference file nào); **canonical là chính từng reference file**. **pk-lint rebuild-index tái sinh bảng này bằng grep ngược** (xem pk-lint/SKILL.md, mục "Sub-mode: rebuild-index"). Khi lệch, grep thực tế thắng.
